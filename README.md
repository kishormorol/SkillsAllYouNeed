...
[![Skills](https://img.shields.io/badge/skills-193-15130E?style=flat-square)](https://kishormorol.github.io/SkillsAllYouNeed/)
...
### Cards & detail sheet
- 193 skill cards in an asymmetric 12-column editorial grid
...
- **[skills.json API](https://kishormorol.github.io/SkillsAllYouNeed/skills.json)** — machine-readable corpus of all 193 skills (CC BY 4.0)
...
All 193 skills are available as a static JSON endpoint:
