...
[![Skills](https://img.shields.io/badge/skills-205-15130E?style=flat-square)](https://kishormorol.github.io/SkillsAllYouNeed/)
...
### Cards & detail sheet
- 205 skill cards in an asymmetric 12-column editorial grid
...
- **[skills.json API](https://kishormorol.github.io/SkillsAllYouNeed/skills.json)** — machine-readable corpus of all 205 skills (CC BY 4.0)
...
All 205 skills are available as a static JSON endpoint:
